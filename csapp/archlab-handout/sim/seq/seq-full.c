...
{
    return ((icode) == (I_IADDQ) || (icode) == (I_IRMOVQ) || (icode) == 
      (I_RMMOVQ) || (icode) == (I_MRMOVQ) || (icode) == (I_JMP) || (icode)
       == (I_CALL));
}
...
long long gen_srcB()
{
    return (((icode) == (I_IADDQ) || (icode) == (I_ALU) || (icode) == 
...
long long gen_aluA()
{
    return (((icode) == (I_RRMOVQ) || (icode) == (I_ALU)) ? (vala) : (
        (icode) == (I_IADDQ) || (icode) == (I_IRMOVQ) || (icode) == 
...
long long gen_aluB()
{
    return (((icode) == (I_IADDQ) || (icode) == (I_RMMOVQ) || (icode) == 
...
{
    return ((icode) == (I_IADDQ) || (icode) == (I_ALU));
}
